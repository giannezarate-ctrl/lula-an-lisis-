-- Disable RLS on pacientes table to allow ETL bulk inserts via anon key
...
-- Disable RLS on etl_logs to allow anonymous writes
ALTER TABLE IF EXISTS etl_logs DISABLE ROW LEVEL SECURITY;
